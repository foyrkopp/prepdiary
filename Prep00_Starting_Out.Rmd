...
- Sven plays **Scorch** (Human Sorcerer)
- Paul plays **Payne** (Tiefling Paladin)
- Wes plays **Winston** (Human Wizard)
- Rachel plays **Rupee** (Human Rogue)
...
- Otherwise, the member with the highest average initiative of each group rolls initiative for the whole group. If any group member has advantage on initiative rolls, they get to roll their own initiative once, too - if they can beat the first roll, their roll is used instead.
...
- The Guild has approached them, either via another member or via mail about unverified reports of a member going Rogue somewhere in the Castrix Province (name provided by Azgaar's Map Algorithm), *probably* somewhere around Renemi.
- Their job is to travel to Renemi and find out what exactly happened. If they can solve the problem themselves, there's a cash bonus, but when in doubt, they're supposed to report back.
...
- The Iron Johan raided two supply/relief convois shortly behind Immelgard, one and three months ago (for the record, it's spring now). To up the ante a bit, one of those convoys was carrying a cask of gunpowder.
- He's a boastful character, always trying to appear of larger station than he actually is - spending generously, trying to mingle with nobility etc.
...
Any discussion of this post should happen [here](https://www.reddit.com/r/DMAcademy/comments/usjx6w/prep_diary_00_starting_out_a_view_over_the/) (Reddit).